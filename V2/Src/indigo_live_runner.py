...
class IndigoRefinedLiveSession:
    def __init__(self):
        ...
        self.strategy = IndigoRefinedStrategy(params={
            'leverage': 4.0,
            'max_capital': 40000,
            'profit_target': 0.025,
            'stop_loss': 0.01
    ...
    def run(self):
        ...
        logger.info(f"INDIGO REFINED LIVE ONLINE: Monitoring {SYMBOL}")
        stream.start()
...
if __name__ == "__main__":
    session = IndigoRefinedLiveSession()
    session.run()
