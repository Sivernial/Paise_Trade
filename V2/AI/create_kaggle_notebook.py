...
def create_notebook():
    ...
    # Cell 3: Deep Quant Model Class (Pasted)
    notebook["cells"].append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Cell 4: Features and Training Logic
    notebook["cells"].append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Write to file
    with open('AI/Paise_Deep_Learning_Export.ipynb', 'w') as f:
        json.dump(notebook, f, indent=4)
    print("Notebook generated: AI/Paise_Deep_Learning_Export.ipynb")
